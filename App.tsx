...
const App: React.FC = () => {
  ...
  const [activeSectionId, setActiveSectionId] = useState<string>(INITIAL_GUIDE_DATA.sections[0].id);
  ...
  return (
    <div className="min-h-screen pb-32 max-w-2xl mx-auto bg-stone-50 text-stone-800 selection:bg-amber-100 font-sans relative">
      {/* Hero Section */}
      ...
      <div className="px-6 py-10 space-y-10">
        ...
        <div className="bg-white rounded-[2.5rem] border border-amber-200 shadow-md ring-1 ring-amber-50 overflow-hidden transition-all duration-300">
          {data.sections.filter(s => s.id === activeSectionId).map(activeSection => (
            <div key={activeSection.id} className="animate-in fade-in slide-in-from-bottom-4 duration-500">
              {/* Header */}
              <div className="p-6 flex items-center gap-5 border-b border-stone-100 bg-stone-50/30">
                <div className="p-4 rounded-2xl border bg-amber-800 border-amber-800 text-white shadow-sm">
